                            ...
                            <li class="splide__slide">
                                <div class="card">
                                    <div class="mini-league">
                                        <img width="25px" src="assets/img/ligas/<?= $ligaImg ?>.png" alt="">
                                        <h5><?= $ligaName ?></h5>
                                    </div>
                                    <div class="main-event">
                                        <div class="match">
                                            <div class="team">
                                                <img src="assets/img/equipos/<?= $ligaImg ?>/<?= $localImg ?>.png" class="image" alt="image">
                                                <!-- <h4><?= ucfirst($local) ?></h4> -->
                                            </div>
                                        </div>
                                        <div <?= $isMotor ?> class="vs">vs</div>
                                        <div <?= $isMotor ?> class="team">
                                            <img src="assets/img/equipos/<?= $ligaImg ?>/<?= $visitaImg ?>.png" class="image" alt="image">
