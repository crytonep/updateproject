    ...
    <div class="appBottomMenu">
        ...
        <a href="<?=$app?>futbol" class="item
        <?php
        if(strpos($actual_link, "futbol")) {
            echo "active";
        } else {}
        ?>
        ">
        ...
        <a href="<?=$app?>chat" class="item
        <?php
        if(strpos($actual_link, "chat")) {
            echo "active";
        } else {}
        ?>">
            <div class="col">
        ...
        <a href="<?=$app?>basketball" class="item
        <?php
        if(strpos($actual_link, "basketball")) {
            echo "active";
        } else {}
        ?>">
            <div class="col">
    ...
    <!-- Bootstrap -->
    <script src="<?=$app?>assets/js/lib/bootstrap.bundle.min.js"></script>
    <!-- Ionicons -->
    <script type="module" src="https://unpkg.com/ionicons@5.5.2/dist/ionicons/ionicons.js"></script>
    <!-- Splide -->
    <script src="<?=$app?>assets/js/plugins/splide/splide.min.js"></script>
    <!-- Base Js File -->
