    ...
    <div class="appBottomMenu">
        ...
        <a id="futbol" href="javascript:void(0)" class="item">
            <div class="col">
                <ion-icon name="document-text-outline"></ion-icon>
                <strong>Fútbol</strong>
            </div>
        </a>
        <a id="basket" href="javascript:void(0)" class="item">
            <div class="col">
                <ion-icon name="apps-outline"></ion-icon>
                <strong>Basket</strong>
            </div>
        </a>
        <a id="tv" href="javascript:void(0)" class="item">
            <div class="col">
                <ion-icon name="card-outline"></ion-icon>
                <strong>TV</strong>
            </div>
        </a>
        <a id="configuracion" href="javascript:void(0)" class="item">
            <div class="col">
            ...
            <div class="modal-content">
                <div class="modal-body p-0">
                    ...
                    <ul class="listview flush transparent no-line image-listview">
                        <li>
                            <a id="home" href="javascript:void(0)" class="item">
